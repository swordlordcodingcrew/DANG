...
function export32Blit(map, fileName) {
    ...
    file.writeLine("");
    file.writeLine("dang::level init_" + functionName + "() {");
    file.writeLine("");

    file.writeLine("    dang::level lvl = {};");

    file.writeLine("");

    file.writeLine("// World ------------------------------------------------");
    file.writeLine("");
    file.writeLine("    lvl.world.width = " + map.width + ";");
    file.writeLine("    lvl.world.height = " + map.height + ";");
    file.writeLine("    lvl.world.tileWidth = " + map.tileWidth + ";");
    file.writeLine("    lvl.world.tileHeight = " + map.tileHeight + ";");
    ...
    for (var i = 0; i < map.layerCount; ++i) {
        ...
        if (layer.isTileLayer) {
            ...
            file.writeLine("    dang::tile t" + layer.name + "[] = {" + buf + "    };");

            var size = layer.width * layer.height;

            file.writeLine("    dang::tilelayer tl" + layer.name + " = {\"" + layer.name + "\"," + size + ",t" + layer.name + "," + layer.width + "," + layer.height + "};");
            file.writeLine("    lvl.layers.push_back(std::make_shared<dang::tilelayer>(tl" + layer.name + "));");
        }
            ...
            for (var j = 0; j < objects.length; ++j) {
                ...
                buf += "        {" + o.id + ",\"" + o.type + "\"," + o.x + "," + o.y + "," + o.width + "," + o.height + "," + o.visible + "," + mTS.get(o.tile.tileset.name) + "," + o.tile.id + "}";
            ...
            file.writeLine("    dang::spriteobject so" + layer.name + "[] = {" + buf + "    };");

            file.writeLine("    dang::objectlayer l" + layer.name + " = {\"" + layer.name + "\"," + objects.length + ",so" + layer.name + "};");
            file.writeLine("    lvl.layers.push_back(std::make_shared<dang::objectlayer>(l" + layer.name + "));");
    ...
    mTS.forEach(function(value, key)
    {
        file.writeLine("    lvl.imagesheets[\"" + key + "\"] = Imagesheet::load(" + key + ");");
    })
